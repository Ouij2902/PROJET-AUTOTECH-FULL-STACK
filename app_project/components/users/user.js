...
export const User = ({user, setUser, showSuccessMessage, showErrorMessage}) => {
    ...
    const deleteUser = async (userToDelete) => {
        ...
        try {
            ...
            showSuccessMessage("La suppression de l'utilisateur est un succès", `L'utilisateur ${response.data.username} a été supprimé !`)
    ...
    const updateUser = async (userToUpdate) => {
        ...
        try {
            ...
            // On montre un message de succès
            showSuccessMessage("La mise à jour de l'utilisateur est un succès", `L'utilisateur ${response.data.username} a été modifié !`)
